...
<div class="bg-color-orange">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2 class="text-center my-4 color-white">Crea un nuovo allenamento</h2>
            </div>
            <div class="col-12">
                ...
                @csrf
                    ...
                    <div class="form-group mb-3">
                        <label class="color-black mb-2" for="title">Dai un titolo al tuo allenamento</label>
                    ...
                    <div class="form-group mb-3">
                        <label class="color-black mb-2" for="duration_weeks">Quante settimane dura?</label>
                        <input type="number" class="form-control input-bg" name="duration_weeks" id="duration_weeks" placeholder="Numero delle settimane" value="{{ old('duration_weeks') }}">
                        @error('duration_weeks')
                            <div class="text-danger">{{$message}}</div>
                        @enderror
                    </div>
                    <div class="form-group">
                        <label class="color-black mb-2" for="notes">Note</label>
                    ...
                    <h2 class="mt-5 mb-4 text-center color-white">Programmi giornalieri</h2>
                    <div id="programs-container">
                        <div class="program">
                            <div class="form-group mb-3">
                                <label class="mb-2 color-black" for="programs[0][week_number]">Numero della settimana</label>
                                <input type="number" name="programs[0][week_number]" class="form-control input-bg" value="{{ old('programs[0][week_number]') }}" required  >
                            ...
                            <div class="form-group mb-3">
                                <label class="mb-2 color-black" for="programs[0][day_of_week]">Giorno della settimana</label>
                            ...
                            <div class="form-group mb-3">
                                <label class="mb-2 color-black" for="programs[0][subtitle]">Nome del programma giornaliero</label>
                            ...
                            <div class="form-group mb-5">
                                <label class="mb-2 color-black" for="programs[0][description]">Descrizione</label>
                    ...
                    <div class="form-group mb-5">
                        ...
                        <button type="submit" class="btn create-button ">Salva Allenamento</button>
                    </div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.getElementById('add-program-button').addEventListener('click', function () {
                ...
                newProgram.innerHTML = `
                    ...
                    <div class="form-group mb-3">
                        <label class="color-black mb-2" for="programs[${programIndex}][week_number]">Numero della settimana</label>
                    ...
                    <div class="form-group mb-3">
                        <label class="color-black mb-2" for="programs[${programIndex}][day_of_week]">Giorno della settimana</label>
                    ...
                    <div class="form-group mb-3">
                        <label class="color-black mb-2" for="programs[${programIndex}][subtitle]">Nome del programma giornaliero</label>
                    ...
                    <div class="form-group mb-5">
                        <label class="color-black mb-2" for="programs[${programIndex}][description]">Descrizione</label>
